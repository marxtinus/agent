...
import { redirect as oauthRedirect } from '@/routes/auth/provider';
</script>

<template>
    <div class="flex flex-col gap-3">
        <Button as-child variant="outline" class="w-full">
            <a :href="oauthRedirect({ provider: 'github' }).url">
                <svg
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    aria-hidden="true"
        ...
        <Button as-child variant="outline" class="w-full">
            <a :href="oauthRedirect({ provider: 'google' }).url">
        ...
        <Button as-child variant="outline" class="w-full">
            <a :href="oauthRedirect({ provider: 'yahoo' }).url">
                <svg
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    aria-hidden="true"
